package com.web.cartalk.core.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.web.cartalk.core.config.Configs;
import com.web.cartalk.core.errors.exception.Exception401;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize ->
                authorize.requestMatchers("/api/join", "/api/login", "/api/help/**", "/api/validate/**", "/api/email-verifications/**", "/h2-console/**", "/api/authentication").permitAll()
